...
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (1, 3456000, 2000, 'ACTIVE', 'SINGLE', 'Bunglow on Sale', null, 1, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (2, 10000, 1000000, 'ACTIVE', 'CONDO', 'Apartment For Sale', null, 2, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (3, 34000, 200, 'ACTIVE', 'DUPLEX', 'House on Sale', null, 3, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (4, 100, 1000, 'ACTIVE', 'CONDO', 'Flat For Rent', null, 4, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (5, 34000, 2000, 'ACTIVE', 'DUPLEX', 'House on Sale', null, 5, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (6, 100, 1200, 'ACTIVE', 'CONDO', 'Apartment For Rent', null, 6, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (7, 3450, 2000, 'ACTIVE', 'DUPLEX', 'Bunglow on Rent', null, 7, 111);
INSERT INTO property (id, area, price, property_status, property_type, title, address_id, details_id, owner_id) VALUES (8, 10000, 10500, 'ACTIVE', 'CONDO', 'Apartment For Rent', null, 8, 111);
